...
import CreateComplaint from "../../pages/CitizenDashboard/CreateComplaint/CreateComplaint";
import { toast } from "react-toastify";
import ComplaintCard from "../ComplaintCard/ComplaintCard";
import styles from "./myComplaints.module.css";
import ComplaintEdit from "../ComplaintEdit/ComplaintEdit";
import CitizenComplaintDetails from "../ComplaintDetails/CitizenComplaintDetails/CitizenComplaintDetails";
const MyComplaints = ({
  scrollRef,
  filtered,
  setLoading,
  ...
  const onEditComplaint = (complaintId) => {
    setSelectedComplaint(complaintId);
    setShowComplaints(false);
    setShowEditComplaint(true);
  };
  ...
  const fetchComplaints = async (customPage = page) => {
    ...
    let url = `https://nagarseva-backend-oy56.onrender.com/citizen/complaints?page=${page}&size=${size}`;
  ...
  const searchComplaint = async (currentPage = page) => {
    ...
    let url = `https://nagarseva-backend-oy56.onrender.com/citizen/complaints/search?page=${currentPage}&size=${size}`;
    if (searchBar.trim() != "") {
  ...
  return (
    <div className={styles.complaints_wrapper}>
          ...
          <div className={styles.complaints_grid}>
            {complaints.map((complaint) => (
              <ComplaintCard
                ...
                buttonPlaceholder={"Edit complaint"}
      ...
      {showEditComplaint && selectedComplaint && (
        <ComplaintEdit
